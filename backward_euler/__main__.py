...
def plot_accuracy_vs_timestep():
    ...
    if nav:  plt.loglog(time_steps_ms[1:], nav11_be_err, 'r',    label='Nav11 Channel,\nBackward Euler')
    ...
    if nav:  plt.loglog(time_steps_ms[1:], nav11_me_err, 'firebrick',  marker='s', label='Nav11 Channel,\nMatrix Exponential')
...
def plot_speed_vs_accuracy():
    ...
    plt.semilogx(max_err, nav11_speed, label='Nav11 Channel, 6 States, 1 Input')
