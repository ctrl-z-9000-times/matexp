...
CALI_CONFIG=runtime-report,calc.inclusive python benchmark.py /dev/null $SEED approx32 $DT $CELLS dedup 2> speed_data/approx32
CALI_CONFIG=runtime-report,calc.inclusive python benchmark.py /dev/null $SEED approx64 $DT $CELLS dedup 2> speed_data/approx64
